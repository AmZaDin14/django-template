...
# Dev
dev:
  npx concurrently --names "tailwind,django" -c '#f0db4f,#4B8BBE' "npx tailwindcss -i static/input.css -o static/css/style.css -w" "python manage.py runserver"

# Build for production
build:
  npx tailwindcss -i static/input.css -o static/css/style.css -m
